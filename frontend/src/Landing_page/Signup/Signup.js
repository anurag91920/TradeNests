...
import axios from "../Login/axiosInstance"; // Axios instance with withCredentials: true
...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("https://tradenests-backend.onrender.com/signup", formData,{
        headers: {
